...
import org.CUCEI.HombreBomba.Objetos.Niveles.Nivel4;
...
public class EstadoNivel4 extends State {
	/**
	...
	public EstadoNivel4(ContenedorDelJuego juego) {
		this.juego = juego;
		// Añadimos mapa
		new Nivel4().crearMapa(listaObjetos);
