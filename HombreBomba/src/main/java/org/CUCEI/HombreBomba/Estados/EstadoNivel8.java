...
import org.CUCEI.HombreBomba.Objetos.Niveles.Nivel8;
...
public class EstadoNivel8 extends State {
	/**
	...
	public EstadoNivel8(ContenedorDelJuego juego) {
		this.juego = juego;
		// Añadimos mapa
		new Nivel8().crearMapa(listaObjetos);
