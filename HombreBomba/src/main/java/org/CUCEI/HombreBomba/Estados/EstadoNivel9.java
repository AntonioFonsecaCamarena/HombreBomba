...
import org.CUCEI.HombreBomba.Objetos.Niveles.Nivel9;
...
public class EstadoNivel9 extends State {
	/**
	...
	public EstadoNivel9(ContenedorDelJuego juego) {
		this.juego = juego;
		// Añadimos mapa
		new Nivel9().crearMapa(listaObjetos);
