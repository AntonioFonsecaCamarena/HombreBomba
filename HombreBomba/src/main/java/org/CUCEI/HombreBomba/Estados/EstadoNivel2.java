...
import org.CUCEI.HombreBomba.Objetos.Niveles.Nivel2;
...
public class EstadoNivel2 extends State {
	/**
	...
	public EstadoNivel2(ContenedorDelJuego juego) {
		this.juego = juego;
		// Añadimos mapa
		new Nivel2().crearMapa(listaObjetos);
