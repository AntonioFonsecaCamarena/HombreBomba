...
import org.CUCEI.HombreBomba.Objetos.Niveles.Nivel7;
...
public class EstadoNivel7 extends State {
	/**
	...
	public EstadoNivel7(ContenedorDelJuego juego) {
		this.juego = juego;
		// Añadimos mapa
		new Nivel7().crearMapa(listaObjetos);
