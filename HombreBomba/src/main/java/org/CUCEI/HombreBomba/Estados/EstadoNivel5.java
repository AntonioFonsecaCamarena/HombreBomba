...
import org.CUCEI.HombreBomba.Objetos.Niveles.Nivel5;
...
public class EstadoNivel5 extends State {
	/**
	...
	public EstadoNivel5(ContenedorDelJuego juego) {
		this.juego = juego;
		// Añadimos mapa
		new Nivel5().crearMapa(listaObjetos);
